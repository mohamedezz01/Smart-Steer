...
public class RedisConfig {
    ...
    public RedisTemplate<String, Object> redisTemplate(RedisConnectionFactory factory) {
        ...
        template.setHashKeySerializer(new StringRedisSerializer()); //if using hashes
         template.setHashValueSerializer(new GenericJackson2JsonRedisSerializer()); //if using hashes
